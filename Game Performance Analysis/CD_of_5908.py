...
requiredata = data[data.loc[:, "code"] == 5908]
...
#partition
partition = [0.0001, 0.3, 0.6 , 0.87, 0.94, 0.95, 0.98, 0.999]
print(partition)
...
plt.suptitle('Distribution of payoff conditioned on betamount of {}, where betamount has max = {}, min = {}, aver = {}'.format('BBIN糖果派對2',Max,Min,Average), fontproperties=font)
