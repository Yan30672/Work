...
requiredata = data[data.loc[:, "code"] == 21]
...
plt.suptitle('Distribution of payoff conditioned on betamount of {}, where betamount has max = {}, min = {}, aver = {}'.format('GPK糖果嘉年華',Max,Min,Average), fontproperties=font)
