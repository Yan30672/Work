...
requiredata = data[data.loc[:, "code"] == 5901]
...
#partition
partition = [0.5, 0.91, 0.94, 0.95, 0.96, 0.975, 0.98, 0.999999]
print(partition)
...
plt.suptitle('Distribution of payoff conditioned on betamount of {}, where betamount has max = {}, min = {}, aver = {}'.format('BBIN連環奪寶',Max,Min,Average), fontproperties=font)
